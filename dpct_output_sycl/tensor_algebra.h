...
typedef struct dpct_type_2f9e3f {
...
typedef struct dpct_type_b29c11 {
 int num_dim; //tensor rank (number of dimensions): >=0; -1:empty
...
typedef struct dpct_type_45647e {
 void * base;
 size_t volume;
 int data_kind;
} talsh_tens_data_t;
...
typedef struct dpct_type_2f5e2c {
...
typedef struct dpct_type_b6b5ff {
