...
typedef struct dpct_type_be576f {
...
typedef struct dpct_type_97b022 {
 int num_dim; //tensor rank (number of dimensions): >=0; -1:empty
...
typedef struct dpct_type_d3db4b {
 void * base;
 size_t volume;
 int data_kind;
} talsh_tens_data_t;
...
typedef struct dpct_type_3ae32d {
...
typedef struct dpct_type_678bff {
