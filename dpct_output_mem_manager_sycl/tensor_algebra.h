...
typedef struct dpct_type_ffc467 {
...
typedef struct dpct_type_972507 {
 int num_dim; //tensor rank (number of dimensions): >=0; -1:empty
...
typedef struct dpct_type_7ca4ef {
 void * base;
 size_t volume;
 int data_kind;
} talsh_tens_data_t;
...
typedef struct dpct_type_25ab56 {
...
typedef struct dpct_type_b13c0b {
